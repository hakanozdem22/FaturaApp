// @ts-nocheck
export default function SecurityLockoutSettingsUpdated() {
        return (
                <>
                                        ...
                                        <div className="w-full max-w-2xl space-y-6">
                                                ...
                                                <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                                                        <div className="flex items-center gap-3 mb-6">
                                                                <span className="flex h-10 w-10 items-center justify-center rounded-full bg-amber-50 text-amber-600 dark:bg-amber-900/20 dark:text-amber-400">
                                                        ...
                                                        <div className="flex items-start justify-between gap-4 p-4 rounded-lg bg-amber-50/50 border border-amber-100 dark:bg-amber-900/10 dark:border-amber-900/30">
                                                                <div>
                                                                        <h5 className="text-sm font-medium text-slate-900 dark:text-white mb-1">Yalnızca Doğrulanmış Alıcılara Gönder</h5>
                                                                        <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed max-w-sm">Etkinleştirildiğinde raporlar yalnızca doğrulama sürecini başarıyla tamamlamış e-posta adreslerine gönderilir.</p>
                                                                </div>
                                                                <label className="relative inline-flex cursor-pointer items-center mt-1">
                                                                        <input checked="" className="peer sr-only" type="checkbox" />
                                                                        <div className="peer h-6 w-11 rounded-full bg-slate-200 after:absolute after:left-[2px] after:top-[2px] after:h-5 after:w-5 after:rounded-full after:border after:border-gray-300 after:bg-white after:transition-all after:content-[''] peer-checked:bg-amber-600 peer-checked:after:translate-x-full peer-checked:after:border-white peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-amber-200 dark:border-gray-600 dark:bg-slate-700 dark:peer-focus:ring-amber-900"></div>
                                                                </label>
                                                        </div><div className="mt-4 flex items-center justify-between gap-4 p-4 rounded-lg bg-slate-50 border border-slate-100 dark:bg-slate-800/50 dark:border-slate-800">
                                                                <div>
                                                                        <h5 className="text-sm font-medium text-slate-900 dark:text-white mb-1">Maksimum Giriş Denemesi</h5>
                                                                        <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed max-w-sm">Bir hesap geçici olarak kilitlenmeden önceki başarısız giriş denemesi sayısını sınırlayın (Hatalı Giriş Denemesi Sınırı).</p>
                                                                </div>
                                                                <div className="flex-shrink-0">
                                                                        <select className="block w-full rounded-lg border-slate-300 bg-white py-2 pl-3 pr-10 text-sm focus:border-primary focus:ring-primary dark:border-slate-700 dark:bg-slate-800 dark:text-white transition-colors">
                                                                                <option value="3">3 deneme</option>
                                                                                <option selected="" value="5">5 deneme</option>
                                                        ...
                                                        <div className="mt-4 px-1">
                                                                <div className="flex items-center gap-2 text-xs text-amber-700 dark:text-amber-400">
                                                                        ...
                                                                        <span>Doğrulanmamış alıcılar aşağıda bir uyarı simgesiyle vurgulanacaktır.</span>
                                                                </div>
                                                        </div>
                                                </div>
                                                <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                                                        ...
                                                        <div className="space-y-6">
                                                                <div>
                                                                        ...
                                                                        <div className="relative">
                                                                                <div className="mb-2 flex flex-wrap gap-2" id="recipient-tags">
                                                                                        <span className="inline-flex items-center gap-1 rounded bg-slate-100 px-2 py-1 text-xs font-medium text-slate-700 dark:bg-slate-800 dark:text-slate-300">
                                                                                                Yöneticiler (3)
                                                                                                <button className="text-slate-400 hover:text-slate-600"><span className="material-symbols-outlined text-[14px]">close</span></button>
                                                                                        </span>
                                                                                        <span className="inline-flex items-center gap-1 rounded bg-slate-100 px-2 py-1 text-xs font-medium text-slate-700 dark:bg-slate-800 dark:text-slate-300 border border-transparent">
                                                                                                Muhasebe Departmanı (Tümü)
                                                                                                <button className="text-slate-400 hover:text-slate-600"><span className="material-symbols-outlined text-[14px]">close</span></button>
                                                                                        </span>
                                                                                        <span className="inline-flex items-center gap-1 rounded bg-red-50 border border-red-200 px-2 py-1 text-xs font-medium text-red-700 dark:bg-red-900/20 dark:border-red-800 dark:text-red-400" title="Doğrulanmamış Alıcı">
                                                                                                <span className="material-symbols-outlined text-[14px] text-red-500">warning</span>
                                                                                                Dış Denetim (doğrulanmamış)
                                                                                                <button className="text-red-400 hover:text-red-600"><span className="material-symbols-outlined text-[14px]">close</span></button>
                                                                                        </span>
                                                                                </div>
                                                                                <select className="w-full rounded-lg border-slate-300 bg-white py-2.5 pl-3 pr-10 text-sm focus:border-primary focus:ring-primary dark:border-slate-700 dark:bg-slate-800 dark:text-white" multiple="">
                                                                                        ...
                                                                                        <option value="external">Dış Denetim (doğrulanmamış)</option>
